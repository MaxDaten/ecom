...
Zu Beginn des Shopbesuchs oder durch einen Klick auf eine der Schaltflächen Home in der Navigationsleiste werden alle vorhandenen Produkte des Katalogs angezeigt \figref{fig:Produktkatalog}. Sollte gerade ein Nutzer angemeldet sein, so werden zusätzlich Empfehlungen prä\-sen\-tiert, die auf seinen getätigten Käufen basieren, sofern vorhanden. Über den Schieberegler \figannotation{1} kann die Reichweite der Empfehlungen erweitert oder eingeschränkt werden. \\
