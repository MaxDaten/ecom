...
\newcommand{\secpref}[1]{(Abschnitt~\ref{#1},~S.~\pageref{#1})}
\newcommand{\appref}[1]{(\appendixname~\ref{#1},~S.~\pageref{#1})}
\newcommand{\coderef}[1]{(Code~\ref{#1},~S.~\pageref{#1})}

% Kreise für Bild-Nummern-Verweise (annotations)
...
%
% ------------------------------------------------------------------------------
\author{Christopher Blöcker, Jan-Philip Loos, Timo Jürgens}
\date{}
